...
function patreon(){
  document.write('<span style="text-align:center;margin: 4px 4px 4px 4px; box-sizing;"><a href="https://www.patreon.com/cw/tekerare" target="_blank"><img src="https://'+ siteURL +'/media/prmo/patreonbanner_donktail.jpg" class="image" alt="join my patreon here" title="only two dollars a month for full access to the 18+ arts."></a></span>');
}
